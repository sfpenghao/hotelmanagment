		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li>
						<a id="dateViewId" onclick="" class="dropdown-toggle" style="cursor:pointer">
						...
						<ul class="submenu">
							<li>
								<a id="yingYeJinEId" onclick="dateView()" class="pointer">
					...
					<li>
						<a id="roomManageId" onclick="roomManage()" class="dropdown-toggle" style="cursor:pointer">
							<i class="icon-home"></i>
							<span class="menu-text">别墅管理 </span>
						...
						<ul class="submenu">
							<li>
								<a id="roomSetId" onclick="roomSet()" class="pointer">
									<i class="icon-double-angle-right"></i>
									<span>别墅设置</span>
								</a>
							</li>
							...
							<li>
								<a id="commoditySetId" onclick="commoditySet()" class="pointer">
									<i class="icon-double-angle-right"></i>
									<span>商品设置</span>
								</a>
							</li>
					...
					<li>
						<a id="stayManageId" onclick="stayManage()" class="dropdown-toggle" style="cursor:pointer">
							<i class="icon-move"></i>
						...
						<ul class="submenu">
							<li>
								<a id="reservationsId" onclick="reservations()" class="pointer">
									<i class="icon-double-angle-right"></i>
									<span>别墅预订</span>
								</a>
							</li>
							...
							<li>
								<a id="personageId" onclick="personage()" class="pointer">
									<i class="icon-double-angle-right"></i>
									<span>住宿登记</span>
								</a>
							</li>
					...
					<li>
						<a id="financeManageId" onclick="financeManage()" class="dropdown-toggle" style="cursor:pointer">
						...
						<ul class="submenu">
							...
							<li>
								<a id="financeStatisticsId" onclick="financeStatistics()" class="pointer">
									<i class="icon-double-angle-right"></i>
									<span>财务统计 </span>
								</a>
							</li>
					...
					<li>
						<a id="passengerManageId" onclick="passengerManage()" class="dropdown-toggle" style="cursor:pointer">
							<i class="icon-user"></i>
						...
						<ul class="submenu">
							...
							<li>
								<a id="passengerInformationId" onclick="passengerInformation()" href="#" class="pointer">
									<i class="icon-double-angle-right"></i>
								<span>旅客信息 </span>	
								</a>
							</li>
							<li>
								<a id="receiveTargetId" onclick="receiveTarget()" href="#" class="pointer">
									<i class="icon-double-angle-right"></i>
								<span>接待对象 </span>	
								</a>
							</li>
